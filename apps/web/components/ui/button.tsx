  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-white hover:bg-secondary/90 hover:shadow-glow",
        outline:
          "border border-primary/40 bg-transparent text-white hover:bg-primary/10 hover:border-primary",
        ghost:
          "bg-white/5 text-white/90 border border-white/10 hover:bg-white/10 hover:border-primary/40",
        destructive:
